...
try {
  $status = (Invoke-WebRequest -Uri "http://216.128.152.177:3000/api/v1/health" -UseBasicParsing -TimeoutSec 5).StatusCode
  if ($status -eq 200) {
    Write-Host "✓ Backend online em http://216.128.152.177:3000" -ForegroundColor Green
  } else {

...
try {
  $status = (Invoke-WebRequest -Uri "http://104.207.142.188:3000/api/v1/health" -UseBasicParsing -TimeoutSec 5).StatusCode
  if ($status -eq 200) {
    Write-Host "✓ Backend online em http://104.207.142.188:3000" -ForegroundColor Green
  } else {

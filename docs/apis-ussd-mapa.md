...
- Config (defaults): `USSD_SIM_BASE_URL=http://104.207.142.188:3001`, `USSD_SIM_ENDPOINT_NEW=/api/payja/ussd/new-customers`, `USSD_SIM_ENDPOINT_ELIG=/api/payja/ussd/eligibility`, `USSD_SIM_ENDPOINT_LOANS=/api/loans`.
...
- Config: `PAYJA_API_URL` (ex.: `http://104.207.142.188:3000`), `PAYJA_API_PREFIX` (ex.: `/api/v1`). Helper `buildPayjaUrl` evita prefixo duplicado.
